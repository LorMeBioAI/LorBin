...
if __name__=="__main__":
    ...
    df = pd.read_excel('./CAMI/evaluation/ari.xlsx',index_col=0)
    ...
    plt.yticks([])
    plt.xticks(fontsize=8)
    plt.figtext(0.45,-0.2,'ARI',fontsize=8)
    ...
    # 显示图形
    plt.savefig('CAMI_MAGs_ari.svg', bbox_inches='tight', pad_inches=0.02, format='svg')
    plt.show()
